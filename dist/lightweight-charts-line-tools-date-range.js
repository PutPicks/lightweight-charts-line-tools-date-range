...
import { LineToolPaneView, SegmentRenderer, TextRenderer, AnchorPoint, deepCopy, LineEnd, BoxHorizontalAlignment, BoxVerticalAlignment, TextAlignment, PaneCursorType, BaseLineTool, merge, InteractionPhase, Point } from 'lightweight-charts-line-tools-core';
 ...
 */
class LineToolDateRangePaneView extends LineToolPaneView {
    constructor(source, chart, series) {
        super(source, chart, series);
        this._arrowLineRenderer = new SegmentRenderer();
        this._dateDifferenceLabelRenderer = new TextRenderer();
    }
    _updateImpl(height, width) {
        ...
        const rectOptions = deepCopy(options.dateRange.rectangle);
        ...
        const borderStyle = options.dateRange.rectangle.border?.style ?? LineStyle.Solid;
        const leftLineRenderer = new SegmentRenderer();
        ...
        const rightLineRenderer = new SegmentRenderer();
    ...
    _addDateDifferenceLabel(renderer, tool, P0, P1, isForward, minX, maxX, minY, maxY) {
        ...
        try {
            ...
            const logical0 = timeScale.coordinateToLogical(minX);
            const logical1 = timeScale.coordinateToLogical(maxX);
 ...
 */
class LineToolDateRange extends BaseLineTool {
    maxAnchorIndex() {
        return 7;
    }
    constructor(coreApi, chart, series, horzScaleBehavior, options = {}, points = [], priceAxisLabelStackingManager) {
        const finalOptions = deepCopy(DateRangeOptionDefaults);
...
export { LineToolDateRange, registerDateRangePlugin as default, registerDateRangePlugin };
//# sourceMappingURL=lightweight-charts-line-tools-date-range.js.map
